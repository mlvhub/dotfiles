...
require("lazy").setup({
  ...
  -- COLORSCHEME ---------------------------------------------------------------
  {
    ...
    lazy = false,
    priority = 1000,
    config = function() vim.cmd("colorscheme nova") end,
  },
  ...
  -- TREESITTER ----------------------------------------------------------------
  {
    ...
    config = function()
      require("nvim-treesitter.config").setup({
        ensure_installed = {
          "lua", "vim", "vimdoc",
          "ocaml", "ocaml_interface", "scala",
          "javascript", "typescript", "tsx",
          "html", "css", "json", "yaml", "toml",
          "markdown", "markdown_inline",
          "git_config", "gitcommit", "diff", "kdl",
        },
  ...
  -- SCALA — nvim-metals -------------------------------------------------------
  {
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd("FileType", {
        pattern = { "scala", "sbt" },
        callback = function() metals.initialize_or_attach(cfg) end,
      })
  ...
  -- FORMATTING — conform.nvim -------------------------------------------------
  {
    ...
    opts = {
      ...
      format_on_save = function(bufnr)
        if vim.bo[bufnr].filetype == "scala" then return end -- metals rewrites syntax
  ...
  -- GIT — diffview (PR-style review of local changes) -------------------------
  {
    ...
    keys = {
      ...
      { "<leader>gD", "<cmd>DiffviewOpen origin/main...HEAD<cr>", desc = "Diff: branch vs origin/main (PR view)" },
  ...
  -- FILE TREE — oil.nvim ------------------------------------------------------
  {
    ...
    keys = {
      ...
      { "<leader>E", function() require("oil").open(vim.fn.expand("%:p:h")) end, desc = "Oil (file dir)" },
    },
    opts = {
